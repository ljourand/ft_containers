...
/*   Updated: 2023/01/09 10:06:28 by ljourand         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
    ...
    class map
    {
      ...
      public:
        ...
        void swap(map &other)
        {
            ...
            value_compare       _buffVComp = _Vcomp;
        ...
        value_compare value_comp(void) const { return (_Vcomp); }
    };
